...
const { create, getProductById, read, remove, update, addRating, addComment
    , getAllProducts, getPromotionalOffers, getSimilarProduct, getProductCategories, getProductListBySearch, getImage, getProductsByCategory, searchProduct } = require("../controllers/product");
...
router.get('/products/offers', getPromotionalOffers);
