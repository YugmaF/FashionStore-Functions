...
const { create, getProductById, read, remove, update, addRating, addComment
    , getAllProducts, getSimilarProduct, getProductCategories, getProductListBySearch, getImage, getProductsByCategory, searchProduct, getPromotionalProducts } = require("../controllers/product");
