...
const { create, getProductById, read, remove, update, addRating, addComment
    , getAllProducts, getSimilarProduct, getProductCategories, getProductListBySearch, getImage, getProductsByCategory, searchProduct, getPromotionalProducts, isPromotionActive } = require("../controllers/product");
...
router.get('/product/:productId/promotion-status', isPromotionActive);
